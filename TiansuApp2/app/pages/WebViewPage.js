...
import CustomTitleBarComp from '../comp/CommonTitleBarComp';
    ...
    if (!this.state.loadEnd) {
      horizontalProgress = (
        <HorizontalProgressComp 
          color={'#FF5000'} 
          progress={60}
          style={{position: 'absolute', left: 0, right: 0, top: TITLE_BAR_HEIGHT + ((Platform.OS === 'android' && Platform.Version <= 19) ? -6 : (Platform.OS === 'android' ? 18 : 20))}}
          />
      );
    }
    return (
