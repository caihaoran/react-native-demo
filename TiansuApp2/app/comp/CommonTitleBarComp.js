...
class CommonTitleBarComp extends Component {
  ...
  render() {
    ...
    let titleBarBackgoundRgba = `rgba(48, 201, 240, ${this.state.opacity})`;
    return (
...
//CommonTitleBarComp.HeaderTabItem = CustomTitleBarHeaderTabComp.HeaderTabItem;

export default CommonTitleBarComp;