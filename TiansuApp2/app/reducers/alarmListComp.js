...
const initialState = {
  status: FETCH_ALARM_DATA_STATUS.INITIALIZE,
  dataArray: {},
...
export default function gankListComp(state=initialState, action) {
  ...
  switch (action.type) {
    case FETCH_ALARM_DATA_STATUS.INITIALIZE:
      return {
        ...state,
        status: action.type,
    ...
    case FETCH_ALARM_DATA_STATUS.START:
      return {
        ...state,
        status: action.type,
        opt: action.opt,
    ...
    case FETCH_ALARM_DATA_STATUS.SUCCESS:
    ...
    case FETCH_ALARM_DATA_STATUS.FAILURE:
      return {
        ...state,
        status: action.type,
        opt: action.opt,
